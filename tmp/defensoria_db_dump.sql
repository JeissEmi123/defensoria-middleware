...
\restrict tGj6FvPpZOiLgsgfmBSq9E4JR7f56i2aST1UCxNgovHHb2J0UikcsRhrzHOmaT5
...
ALTER TABLE IF EXISTS ONLY sds.senal_detectada DROP CONSTRAINT IF EXISTS fk_senal_categoria_senal;
ALTER TABLE IF EXISTS ONLY sds.senal_detectada DROP CONSTRAINT IF EXISTS fk_senal_categoria_analisis;
ALTER TABLE IF EXISTS ONLY sds.resultado_observacion_senal DROP CONSTRAINT IF EXISTS fk_res_obs_senal;
ALTER TABLE IF EXISTS ONLY sds.resultado_observacion_senal DROP CONSTRAINT IF EXISTS fk_res_obs_categoria;
ALTER TABLE IF EXISTS ONLY sds.palabra_clave DROP CONSTRAINT IF EXISTS fk_palabra_categoria_analisis;
ALTER TABLE IF EXISTS ONLY sds.medios_digitales DROP CONSTRAINT IF EXISTS fk_medios_digitales_cat_observacion;
ALTER TABLE IF EXISTS ONLY sds.influencers DROP CONSTRAINT IF EXISTS fk_influencers_cat_observacion;
ALTER TABLE IF EXISTS ONLY sds.frase_clave DROP CONSTRAINT IF EXISTS fk_frase_categoria_analisis;
ALTER TABLE IF EXISTS ONLY sds.figuras_publicas DROP CONSTRAINT IF EXISTS fk_fig_publica_cat_observacion;
ALTER TABLE IF EXISTS ONLY sds.entidades DROP CONSTRAINT IF EXISTS fk_entidades_cat_observacion;
ALTER TABLE IF EXISTS ONLY sds.emoticon DROP CONSTRAINT IF EXISTS fk_emoticon_categoria_analisis;
ALTER TABLE IF EXISTS ONLY sds.conducta_vulneratoria DROP CONSTRAINT IF EXISTS fk_conducta_categoria_analisis;
...
ALTER TABLE IF EXISTS ONLY public.roles_permisos DROP CONSTRAINT IF EXISTS roles_permisos_rol_id_fkey;
ALTER TABLE IF EXISTS ONLY public.roles_permisos DROP CONSTRAINT IF EXISTS roles_permisos_permiso_id_fkey;
ALTER TABLE IF EXISTS ONLY public.password_history DROP CONSTRAINT IF EXISTS password_history_usuario_id_fkey;
ALTER TABLE IF EXISTS ONLY public.eventos_auditoria DROP CONSTRAINT IF EXISTS eventos_auditoria_usuario_id_fkey;
DROP INDEX IF EXISTS public.ix_usuarios_roles_usuario_id;
DROP INDEX IF EXISTS public.ix_usuarios_roles_rol_id;
DROP INDEX IF EXISTS public.ix_usuarios_nombre_usuario;
DROP INDEX IF EXISTS public.ix_usuarios_id_externo;
DROP INDEX IF EXISTS public.ix_usuarios_email;
DROP INDEX IF EXISTS public.ix_usuarios_activo;
DROP INDEX IF EXISTS public.ix_sesiones_valida;
DROP INDEX IF EXISTS public.ix_sesiones_usuario_id;
DROP INDEX IF EXISTS public.ix_sesiones_fecha_expiracion;
DROP INDEX IF EXISTS public.ix_roles_permisos_rol_id;
DROP INDEX IF EXISTS public.ix_roles_permisos_permiso_id;
DROP INDEX IF EXISTS public.ix_roles_nombre;
DROP INDEX IF EXISTS public.ix_roles_activo;
DROP INDEX IF EXISTS public.ix_permisos_recurso;
DROP INDEX IF EXISTS public.ix_permisos_codigo;
DROP INDEX IF EXISTS public.ix_password_history_usuario_id;
DROP INDEX IF EXISTS public.ix_password_history_id;
DROP INDEX IF EXISTS public.ix_password_history_fecha_creacion;
DROP INDEX IF EXISTS public.ix_eventos_auditoria_usuario_id;
DROP INDEX IF EXISTS public.ix_eventos_auditoria_tipo_evento;
DROP INDEX IF EXISTS public.ix_eventos_auditoria_resultado;
DROP INDEX IF EXISTS public.ix_eventos_auditoria_fecha_evento;
DROP INDEX IF EXISTS public.ix_configuracion_sistema_clave;
DROP INDEX IF EXISTS public.ix_configuracion_sistema_categoria;
DROP INDEX IF EXISTS public.idx_usuario_reset_token;
ALTER TABLE IF EXISTS ONLY sds.senal_detectada DROP CONSTRAINT IF EXISTS senal_detectada_pkey;
ALTER TABLE IF EXISTS ONLY sds.resultado_observacion_senal DROP CONSTRAINT IF EXISTS resultado_observacion_senal_pkey;
ALTER TABLE IF EXISTS ONLY sds.palabra_clave DROP CONSTRAINT IF EXISTS palabra_clave_pkey;
ALTER TABLE IF EXISTS ONLY sds.medios_digitales DROP CONSTRAINT IF EXISTS medios_digitales_pkey;
ALTER TABLE IF EXISTS ONLY sds.influencers DROP CONSTRAINT IF EXISTS influencers_pkey;
ALTER TABLE IF EXISTS ONLY sds.frase_clave DROP CONSTRAINT IF EXISTS frase_clave_pkey;
ALTER TABLE IF EXISTS ONLY sds.figuras_publicas DROP CONSTRAINT IF EXISTS figuras_publicas_pkey;
ALTER TABLE IF EXISTS ONLY sds.entidades DROP CONSTRAINT IF EXISTS entidades_pkey;
ALTER TABLE IF EXISTS ONLY sds.emoticon DROP CONSTRAINT IF EXISTS emoticon_pkey;
ALTER TABLE IF EXISTS ONLY sds.conducta_vulneratoria DROP CONSTRAINT IF EXISTS conducta_vulneratoria_pkey;
ALTER TABLE IF EXISTS ONLY sds.categoria_senal DROP CONSTRAINT IF EXISTS categoria_senal_pkey;
ALTER TABLE IF EXISTS ONLY sds.categoria_observacion DROP CONSTRAINT IF EXISTS categoria_observacion_pkey;
ALTER TABLE IF EXISTS ONLY sds.categoria_analisis_senal DROP CONSTRAINT IF EXISTS categoria_analisis_senal_pkey;
...
ALTER TABLE IF EXISTS ONLY public.permisos DROP CONSTRAINT IF EXISTS permisos_codigo_key;
ALTER TABLE IF EXISTS ONLY public.password_history DROP CONSTRAINT IF EXISTS password_history_pkey;
ALTER TABLE IF EXISTS ONLY public.eventos_auditoria DROP CONSTRAINT IF EXISTS eventos_auditoria_pkey;
ALTER TABLE IF EXISTS ONLY public.configuracion_sistema DROP CONSTRAINT IF EXISTS configuracion_sistema_pkey;
ALTER TABLE IF EXISTS ONLY public.configuracion_sistema DROP CONSTRAINT IF EXISTS configuracion_sistema_clave_key;
...
ALTER TABLE IF EXISTS public.eventos_auditoria ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.configuracion_sistema ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.eventos_auditoria_id_seq;
DROP TABLE IF EXISTS public.eventos_auditoria;
DROP SEQUENCE IF EXISTS public.configuracion_sistema_id_seq;
DROP TABLE IF EXISTS public.configuracion_sistema;
DROP TABLE IF EXISTS public.alembic_version;
DROP FUNCTION IF EXISTS sds.sync_categoria_analisis(p_id_categoria smallint, p_payload jsonb);
DROP FUNCTION IF EXISTS sds.delete_categoria_analisis(p_id_categoria smallint);
DROP FUNCTION IF EXISTS sds.create_categoria_analisis_full(p_id_categoria smallint, p_payload jsonb);
DROP TYPE IF EXISTS public.tipo_autenticacion;
DROP SCHEMA IF EXISTS sds;
--
...
\unrestrict tGj6FvPpZOiLgsgfmBSq9E4JR7f56i2aST1UCxNgovHHb2J0UikcsRhrzHOmaT5
